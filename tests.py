...
class TestBase(TestCase):
    ...
    def create_app(self):
        ...
        app.config.update(
            SQLALCHEMY_DATABASE_URI='postgres://postgres:Asorock1@localhost/dreamteam_test'
        )
        return app
    ...
    def setUp(self):
        ...
        admin = Employee(username="admin", password="Testing", is_admin=True)
...
class TestModels(TestBase):
    ...
    def test_department_model(self):
        """
        Test number of recodrs in Department table
        """

        # create test department
        department = Department(name="IT", description="Our department")
    ...
    def test_role_model(self):
        ...
        # create test role
        role = Role(name="Assistant Engineer", description="Run the whole company")
...
class TestViews(TestBase):
    ...
    def test_roles_view(self):
        ...
        and redirects to login oage then to roles page
        """
    ...
    def test_employees_view(self):
        ...
        and redirects to login page then to employee page
        """
...
class TestErrorPages(TestBase):
    ...
    def test_403_forbidden(self):
        ...
        self.assertTrue(error.encode('utf-8') in response.data)
